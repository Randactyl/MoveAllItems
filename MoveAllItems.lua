...
local function AddGuildWithdrawButton()
	...
	guildButton:SetAnchor(RIGHT, ZO_GuildBankInfoBarMoney, LEFT, -10, 0)
...
local function AddWithdrawButton()
	...
	withdrawButton:SetAnchor(RIGHT, ZO_PlayerBankInfoBarMoney, LEFT, -10, 0)
...
local function AddDepositButton()
	...
	depositButton:SetAnchor(RIGHT, ZO_PlayerInventoryInfoBarAlliancePoints, LEFT, -5, 0)
